  ...
  if ((summary.engines || []).length > 0) {
    ...
    visibilityCells.push(`
      <article class="cell span-6 quiet">
        ...
        <p class="cell-sub">Every engine got the same questions. &ldquo;Named&rdquo; = your brand appears in the answer; &ldquo;citations&rdquo; = your domain appears in sources.${summary.coverage.yes === 0
  ...
  if (summary.positionMatrix && summary.positionMatrix.length > 0) {
    ...
    if (revealItems.length > 0) {
      ...
      <article class="cell span-6 quiet">
        ...
        <p class="reveals-hint">Click any row to expand the full verbatim answer the engine gave.</p>
        <div aria-label="Full engine answers">
          ${revealItems.join('\n          ')}
        </div>
      </article>`);
    }
