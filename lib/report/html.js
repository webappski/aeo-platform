...
export function renderHtml(summary, snapshots = null, opts = {}) {
  ...
  // condition satisfied, all three modes). `funnel` stays: it is dead here too,
  // but nothing in the HTML shows funnel-stage visibility, so dropping it would
  // lose content rather than duplicate it — that one is the founder's call.
