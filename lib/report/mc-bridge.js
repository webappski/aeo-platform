...
export function bridgeMarkup(state) {
  ...
  const price        = pricing.priceLabel    || '€129 per plan';
  const priceMeta    = pricing.priceMetaLine || '€129 per plan · 30 missions';
  ...
  const earlyBirdPromoLine    = pricing.promoLine
    || `<b>${earlyBirdLong}</b> get a free 30-mission AEO plan (≈1–3 hours per mission, work at your pace). €129 after that. Limited spots.`;
