 ...
 * case where the static table was corrected upward (e.g. gpt-5-search-api
 * 6k→500k in 2026-07) but the persisted file was written before the fix.
 * Without this guard, the scheduler would pace forever on the old low number,
 * since learnTpmLimit is shrink-only and a live 200 header can only rescue it
 * on the first successful call, which happens AFTER the pacing decision.
 *
