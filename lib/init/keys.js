 ...
 * general classifier). Order matches PROVIDER_PRIORITY (lib/config.js,
 * decision Alex 2026-07-08: Gemini, Claude, GPT).
 */
export const RESEARCH_CAPABLE = ['gemini', 'anthropic', 'openai'];
