...
import { AMBIGUOUS_ACRONYMS } from './acronyms.js';

// Re-exported for backward compatibility — score.js and tests import the list
// from here. The canonical definition lives in acronyms.js (single source of
// truth, shared with brainstorm's prompt rule).
export { AMBIGUOUS_ACRONYMS };
