...
/**
 * Tokenise a query or product-line label into comparable product nouns —
 * lower-cased, punctuation-stripped, short/structural tokens and stopwords
 * dropped. Exported so score.js's product-line overlap uses the SAME semantics
 * (token equality, not naive substring), keeping the coverage axis and the
 * brand-fit classifier in lockstep.
 *
 * @param {string} s
 * @returns {string[]}
 */
